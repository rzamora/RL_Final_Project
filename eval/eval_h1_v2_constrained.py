...
HL_V2_DIR = PATHS.checkpoints / "hl_synth_pretrain_v2_constrained_gross"

# Best on real_test in v2 was step 250000 (eval reward -16,05). Best on
# real_train was step 200000 (eval reward -2.05). Final at 1M.
HL_V2_CHECKPOINTS = [
    (
        "hl_v2_cg_250k_best_test",
        HL_V2_DIR / "best_on_real_test" / "best_model.zip",
        HL_V2_DIR / "ppo_hl_v2_cg_vecnormalize_300000_steps.pkl",
    ),
    (
        "hl_v2_cg_1M_final",
        HL_V2_DIR / "hl_v2_cg_final.zip",
        HL_V2_DIR / "hl_v2_cg_final_vecnorm.pkl",
    ),
]
N_SEEDS = 10
